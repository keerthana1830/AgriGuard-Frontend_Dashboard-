...
export const Header: React.FC<HeaderProps> = ({ currentView, setCurrentView, onChatToggle, username, onLogout, settings }) => {
  ...
  const navItems = [
    { id: 'dashboard', label: t('header_dashboard'), icon: LeafIcon },
    { id: 'field', label: t('header_fieldHealth'), icon: MapIcon },
    { id: 'history', label: t('header_history'), icon: DocumentDuplicateIcon },
    { id: 'achievements', label: t('header_achievements'), icon: TrophyIcon },
    { id: 'resources', label: t('header_resources'), icon: BookOpenIcon },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:p-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            ...
            <span className="ml-2 text-2xl font-bold text-text-primary">{t('appName')}</span>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            >
              ...
              <span className="hidden sm:inline">{t('header_aiAssistant')}</span>
            </button>
