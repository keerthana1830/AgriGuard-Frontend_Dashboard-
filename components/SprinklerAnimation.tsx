  ...
  return (
    ...
    >
      ...
      <div className="text-center text-white z-10 animate-fade-in-scale">
        ...
        <h2 className="text-3xl font-bold mt-4">{t('sprinkler_title')}</h2>
        <p className="text-lg opacity-80">{t('sprinkler_desc')}</p>
        <p className="text-sm opacity-70 mt-4 animate-pulse">{t('sprinkler_continue')}</p>
      </div>
      <style>{`
        @keyframes rain-drop {
          from {
